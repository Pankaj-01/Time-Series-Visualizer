...
df = pd.read_csv('/workspace/boilerplate-mean-variance-standard-deviation-calculator/Time Series Visualizer/fcc-forum-pageviews.csv', index_col="date", parse_dates=True)
